...
"""
#MODIFIED VERSION OF robotparser
#Program Name: Url.py
#Python Version: 3
#Description: Modified version of robotparser
...
class RuleLine:
    ...
    def applies_to(self, filename):
        ...
        #return self.path == "*" or filename.startswith(self.path) #MODIFIED (bdm) 2019-11-16
        return self.path == "*" or self.path.startswith(filename) #MODIFIED (bdm) 2019-11-16
